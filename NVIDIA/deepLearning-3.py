# This program performs image classification. The image is captured using the jetson.utils and classified against the trained model. The Recognized item is displayed using CV2 
